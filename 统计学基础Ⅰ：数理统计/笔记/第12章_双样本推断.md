---
title: "第 12 章：双样本推断（Two-Sample Inferences）"
course: "统计学基础：数理统计"
---
...
消毒组 $34/40$ 存活，未消毒组 $19/35$ 存活。检验 $H_0:p_1=p_2$ 时，零假设下采用合并比例

$$
\hat p=\frac{34+19}{40+35}=\frac{53}{75}.
$$
...
对同一模型、同一标准误和同一双侧显著性水平，检验 $H_0:\theta=\theta_0$ 在水平 $\alpha$ 下拒绝，当且仅当 $100(1-\alpha)\%$ 置信区间不包含 $\theta_0$。区间还同时展示方向、效果量与精度，因此结果报告通常应以估计值和区间为主体，以 p-value 为补充。
