...
| 章节 | 学习笔记 | 核心问题 |
|---|---|---|
| 第1章 | [概率论导论](第1章_概率论导论.md) | 怎样用事件与概率描述随机实验？ |
| 第2章 | [随机变量 I](第2章_随机变量I.md) | 怎样从事件过渡到随机变量与分布？ |
| 第3章 | [随机变量 II](第3章_随机变量II.md) | 期望、方差、联合分布和变换如何计算？ |
| 第4章 | [随机变量 III](第4章_随机变量III.md) | 顺序统计量、条件分布、MGF 如何服务推断？ |
| 第5章 | [特殊分布](第5章_特殊分布.md) | 常见分布之间有什么生成关系？ |
| 第6章 | [渐近理论与蒙特卡洛](第6章_渐近理论与蒙特卡洛.md) | 大样本下随机量怎样稳定和近似？ |
| 第7章 | [参数估计](第7章_参数估计.md) | 如何估计未知参数并评价估计量？ |
| 第8章 | [参数估计 II](第8章_参数估计II.md) | 什么统计量保留信息？估计量的大样本表现如何？ |
| 第9章 | [假设检验](第9章_假设检验.md) | 如何在错误概率受控下作统计决策？ |
| 第10章 | [正态分布推断](第10章_正态分布推断.md) | 正态总体下如何做均值和方差推断？ |
| 第11章 | [数据类型概览](第11章_数据类型概览.md) | 不同数据结构应选择什么分析方法？ |
| 第12章 | [双样本推断](第12章_双样本推断.md) | 两个总体的均值、方差、比例如何比较？ |
| 第13章 | [线性回归与 Lasso](第13章_线性回归与Lasso.md) | 如何建模多个变量与响应的关系，并做高维选择？ |
| 第14章 | [收缩估计与方差分析](第14章_收缩估计与方差分析.md) | 如何借用组间信息，并比较多个总体均值？ |
| 第15章 | [随机区组与非参数方法](第15章_随机区组与非参数方法.md) | 如何控制已知异质性，并在弱分布假设下推断？ |
| 第16章 | [因果推断](第16章_因果推断.md) | 在什么假设下可以从关联识别因果效应？ |
