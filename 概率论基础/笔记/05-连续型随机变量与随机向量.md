...
若 $(\xi_1,\ldots,\xi_n)$ 有联合密度 $f$，则： $E\varphi(\xi_1,\ldots,\xi_n)=\int_{\mathbb R^n}\varphi(x_1,\ldots,x_n)f(x_1,\ldots,x_n)\,dx_1\cdots dx_n.$
...
二维正态分布常写为： $f(x,y)=\frac{1}{2\pi\sigma_1\sigma_2\sqrt{1-\rho^2}}\exp\left(-\frac{1}{2(1-\rho^2)}\left[\frac{(x-\mu_1)^2}{\sigma_1^2}-\frac{2\rho(x-\mu_1)(y-\mu_2)}{\sigma_1\sigma_2}+\frac{(y-\mu_2)^2}{\sigma_2^2}\right]\right).$
