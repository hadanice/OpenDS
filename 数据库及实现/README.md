...
这组笔记按 `课件` 的章节整理，把每章的概念、规则、语法和易错点整理成便于复习的知识图谱。同时整理了课程项目安排，方便对照项目要求完成数据库案例设计与实现。建议先看本文件的总览，再按章节文件逐个复习；做项目时配合阅读 [课程项目安排.md](课程项目安排.md)。
...
| 资料 | 内容 |
| --- | --- |
| [课程项目安排.md](课程项目安排.md) | 数据库案例设计与实现的项目要求、阶段安排、评分导向、选题概览和交付清单 |
...
8. 做课程项目时先看 [课程项目安排.md](课程项目安排.md)，再回到第 2、3、5、6、7、9 章查范式、ER 到关系模式、表约束、查询、索引和事务等细节。
...
| 扩展性 | 单机不够时怎样扩展？ | 12 |
| 项目实践 | 如何把需求分析、ER 图、表设计和系统实现串起来？ | [课程项目安排.md](课程项目安排.md), 2, 3, 5, 6, 7, 9 |
